...
SRCS := Main.cpp Mesh.cpp Scene.cpp MyScene.cpp Camera.cpp Vector3.cpp KeyBuffer.cpp Matrix3.cpp Transform.cpp MouseBuffer.cpp Vector4.cpp Matrix4.cpp Geometry.cpp ColorsMesh.cpp NormalsMesh.cpp LightSource.cpp ShaderProgram.cpp OpenGLContext.cpp RealOpenGLContext.cpp

  ...
  : Scene::Scene (genInfo, camera)
{
  ...
  this->add ("decagon", new ColorsMesh (context, colorInfo));
  ...
  this->add ("triangle", new ColorsMesh (context, colorInfo));
  ...
  ColorsMesh* firstCube = new ColorsMesh (context, colorInfo);
  ...
  ColorsMesh* secondCube = new ColorsMesh (context, colorInfo);
  ...
  NormalsMesh* thirdCube = new NormalsMesh (context, normInfo);
  ...
  NormalsMesh* fourthCube = new NormalsMesh (context, normInfo);
  ...
  NormalsMesh* bear = new NormalsMesh (context, genInfo, "models/bear.obj", 0);
  Material* emerald = new Material (Vector3 (0.0215f, 0.1745f, 0.00215f), Vector3 (0.07568f, 0.61424f, 0.07568f),
    Vector3 (0.633f, 0.727811f, 0.633f), 0.6f);

  this->add ("bear", bear);
  this->getMesh ("bear")->scaleWorld (0.25f);
  this->getMesh ("bear")->setMaterial (emerald);
  this->getMesh ("bear")->moveRight (16.0f);
  this->getMesh ("bear")->moveUp (-3.0f);
  this->getMesh ("bear")->yaw (-40.0f);
